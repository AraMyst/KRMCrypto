...
const australiaArticles: Article[] = [
...
const [feature1, feature2, special, ...rest] = australiaArticles

const specialText = `IG Group amplia seu alcance ao oferecer trading direto de criptomoedas para investidores australianos, incorporando rigorosos controles de risco e suporte regulamentar.`

export default function AustraliaIndexPage() {
  return (
    <>
      <Head>
        <title>Australia – iDontKnowCrypto</title>
        <meta
          name="description"
          content="Novidades cripto na Austrália: trading, regulamentações e métricas de adoção."
        />
      </Head>
