...
export default function AirdropsIndexPage() {
  return (
    <>
      <Head>
        <title>Airdrops – iDontKnowCrypto</title>
        <meta
          name="description"
          content="Comprehensive coverage of crypto airdrops: opportunities, strategies and updates."
        />
      </Head>
