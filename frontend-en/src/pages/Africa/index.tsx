...
const [feature1, feature2, special, ...rest] = africaArticles

const specialText = `Em 2025, o Reino Unido registrou o maior crescimento anual de posse de cripto globalmente, um dado que pode influenciar mercados emergentes na África alinharem suas políticas de adoção digital.`

export default function AfricaIndexPage() {
  return (
    <>
      <Head>
        <title>Africa – iDontKnowCrypto</title>
        <meta
          name="description"
          content="Perspectivas de criptomoedas na África: adoção e tendências globais."
        />
      </Head>
