...
// Ordem específica para Global
const globalArticles: Article[] = [
  articles[1], // UK Crypto Investigator (feature1)
  articles[5], // FCA Stablecoin/Custody (feature2)
  articles[0], // BCP Stablecoin (destaque principal)
  articles[2],
  articles[3],
  articles[4],
  articles[6],
...
const specialText = `BCP Technologies lançou o tGBP, uma stablecoin lastreada na libra esterlina que poderá servir de padrão para futuras regulações da FCA, ampliando o uso de moedas digitais ancoradas em ativos reais.`
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Notícias globais sobre criptomoedas: regulações, mercado e inovações."
        />
      </Head>
