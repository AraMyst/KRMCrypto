// src/pages/news/UK/reform-uk-accepts-crypto-donations-nigel-farage.tsx
  ...
  return (
    <>
      ...
      <article className="prose lg:prose-xl space-y-6 max-w-3xl mx-auto px-4 py-8">
        ...
        <p>
          To facilitate crypto donations, Reform UK has partnered with Radom, a leading crypto payment service provider. This move positions the party distinctively against traditional powerhouses—the Labour and Conservative parties—neither of whom currently accept digital currencies.
        </p>
        ...
        <p>
          “Approximately seven million Britons hold crypto assets,” Farage noted, underscoring the widespread adoption and significance of cryptocurrencies among younger demographics, “one in four people under 30 are crypto holders, reflecting the direction our financial future is heading.”
        </p>
        ...
        <p>
          Farage’s appearance at the Bitcoin 2025 event aligned him with notable international crypto advocates, including supporters of former US President Donald Trump. Reform UK’s proactive embrace of cryptocurrency not only distinguishes its policy platform but also resonates with global trends toward greater crypto integration into mainstream financial systems.
        </p>
      </article>
    </>
  )
