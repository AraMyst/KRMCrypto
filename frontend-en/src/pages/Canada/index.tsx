...
const canadaArticles: Article[] = [
  articles[1], // UK Crypto Investigator
  articles[5], // FCA Stablecoin/Custody
  articles[0], // BCP Technologies (destaque principal)
  articles[2],
  articles[3],
  articles[4],
  articles[6],
...
const [feature1, feature2, special, ...rest] = canadaArticles

const specialText = `BCP Technologies lançou o tGBP para oferecer aos investidores canadenses uma stablecoin lastreada na libra esterlina, promovendo maior liquidez e cumplicidade regulatória internacional.`

export default function CanadaIndexPage() {
  return (
    <>
      <Head>
        <title>Canada – iDontKnowCrypto</title>
        <meta
          name="description"
          content="Notícias de criptomoedas no Canadá: novos produtos e tendências."
        />
      </Head>
